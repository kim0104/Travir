...
namespace MalbersAnimations.Selector
{
    ...
    public class SelectorControllerEditor : Editor
    {
        ...
        SerializedProperty RestoreTime, AnimateSelection, SoloSelection, SelectionTime, SelectionCurve, DragSpeed, dragHorizontal, inertia, inertiaTime, minInertiaSpeed, inertiaCurve, debug, FocusedItemIndex,
