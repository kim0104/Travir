...
public class MenuPanel : MonoBehaviour
{
    ...
    public SeoulMapManager seoulMapManager; // SeoulMapManager ÂüÁ¶
    void OnGimpoClick()
    {
        Data.spawnType = Data.SpawnType.Gimpo;
        GameObject player = GameObject.FindGameObjectWithTag("Player"); // ÇÃ·¹ÀÌ¾î ÅÂ±×¸¦ »ç¿ëÇÏ¿© ÇÃ·¹ÀÌ¾î °´Ã¼¸¦ Ã£½À´Ï´Ù.
