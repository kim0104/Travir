...
namespace MalbersAnimations.Selector
{
    ...
    [HelpURL("https://malbersanimations.gitbook.io/animal-controller/ultimate-selector/selector-item")]
    [AddComponentMenu("Malbers/Ultimate Selector/Selector Item")]
    public class MItem : MonoBehaviour
    {
        ...
        /// <summary> Set a Lock Material to the current item  </summary>
