...
namespace MalbersAnimations.Selector
{
    ...
    public partial class SelectorController
    {
       ...
       // bool InertiaInterrupted;
        ...
        {
            get => isChangingItem;
            set => OnIsChangingItem.Invoke(isChangingItem = value);
        }
        ...
        /// <summary>  The Camera for the Selector  </summary>
        protected Camera S_Camera => S_Editor.SelectorCamera;

        public int FocusedItemIndex { get => focusedItemIndex; set => focusedItemIndex = value; }
        #endregion
